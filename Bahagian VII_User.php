...
<body>
    ...
    <script>
        function loadAllParts() {
            ...
            const descriptions = {
               'A': 'Kerja - kerja menanggal sahaja tanpa skop pemasangan baru',

                'B': 'Kerja-kerja memasang peralatan sahaja tanpa pembekalan',

                'C': 'Kerja-kerja menyediakan bukaan dan membaiki',

                'D': 'Membekal dan memasang',

                'E': 'Kerja-Kerja Pengujian',
            ...
            parts.forEach(part => {
                fetch(`fetch_data_VII.php?part=${part}`)
