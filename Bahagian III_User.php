...
<body>
    <h1>BAHAGIAN III : ALAT - ALAT LENGKAP PENDAWAIAN ELEKTRIK</h1>
    ...
    <script>
        ...
        function loadAllParts() {
            ...
            const descriptions = {
                'A': 'Suis bertebat penuh <br><br> Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',

                'B': 'B Suis terlitup logam (metaclad).<br><br Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',

                'C': 'Punca Alir Keluar (PAK) , bertebat penuh <br><br> Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',

                'D': 'Punca Alir Keluar (PAK) , terlitup logam (metalclad) <br><br> Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',

                'E': 'Komponen-komponen pendawaian <br><br>Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',

                'F': 'Alat-alat lengkap konduit dan trunking <br><br> Membekal dan memasang semua bahan mengikut spesifikasi piawai JKR',
            ...
            parts.forEach(part => {
                fetch(`fetch_data_III.php?part=${part}`)
