...
<body>
    <h1>BAHAGIAN IV : LENGKAPAN PENCAHAYAAN, LAMPU, KOMPONEN-KOMPONEN LAMPU DAN KIPAS</h1>
    ...
    <script>
        function loadAllParts() {
            ...
            const descriptions = {
               'A': 'Membekal dan memasang semua bahan mengikut spesifikasi standard JKR',

                'B': 'Lengkapan Pendarfluor Jenis T8 : <br><br> Lengkapan Pendarfluor dengan balast elektromagnetik jenis kehilangan rendah 6W atau kurang l/d tiub, pemula dan pemuat faktor kuasa:',

                'C': 'Lengkapan Pendarfluor Jenis T5 <br><br> Lengkapan Pendarfluor dengan balast elektronik jenis kehilangan rendah 3W atau kurang l/d tiub, :',

                'D': 'Lengkapan LED <br><br> Lengkapan LED lengkap dengan tiub LED 2 pin jenis G13, pemacu LED (LED driver) , faktor kuasa > 0.9 dan kecekapan > 90 lm/W :- ',

                'E': 'Lengkapan Anti Corrosive <br><br> Lengkapan LED lengkap dengan tiub LED 2 pin jenis G13, pemacu LED (LED driver), faktor kuasa > 0.9 dan kecekapan > 90 lm/W :-',

                'F': 'Lengkapan Am',

                'G': 'Komponen dan alat ganti lengkapan',

                'H': 'Kipas dan alat ganti kipas'
            };
            ...
            parts.forEach(part => {
                fetch(`fetch_data_IV.php?part=${part}`)
